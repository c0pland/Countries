...
class CountryUnionViewModel: ObservableObject {
	lazy var nato = CountryUnion(fullName: "North Atlantic Treaty Organisation", abbreviation: "NATO", dateOfCreation: "April 4, 1949", numberOfMembers: 30, members: ["USA", "Canada", "France", "Germany", "Italy", "Norway", "Denmark", "Netherlands", "Luxembourg", "Belgium", "United Kingdom", "Iceland", "Portugal", "Spain", "Greece", "Turkey", "Czech Republic", "Hungary", "Poland", "Bulgaria", "Romania", "Slovakia", "Estonia", "Latvia", "Lithuania", "Albania", "Croatia", "North Macedonia", "Slovenia", "Montenegro"])
	...
	lazy var unions = [nato, europeanUnion, schengenArea, eurozone]
